...
public class InformerTest {
	...
	@Test
	public void test() {
		Address adress = new Address(Arrays.asList(
				"Mahahunupitiya", "Negombo"), 12);
		Address adress1 = new Address(Arrays.asList(
				"Mahahunupitiya1", "Negombo1"), 121);
		Address adress2 = new Address(Arrays.asList(
				"Mahahunupitiya2", "Negombo2"), 122);
...
//				.addMethodCondition(StringConditions.or(StringConditions.equals("getName"), StringConditions.startsWith("getA")))
...
//
//				})
//				//.putDescriptor(Address.class, Descriptors.getToStringDescriptor(Address.class))
